...
export type UserPermission = 'cotizaciones' | 'servicios' | 'compras' | 'configuracion' | 'inventario' |
	'maestras_personas' | 'maestras_maquinas' | 'maestras_pagos' | 'maestras_inventario' | 'pañol' | 'utilizacion_hh';
