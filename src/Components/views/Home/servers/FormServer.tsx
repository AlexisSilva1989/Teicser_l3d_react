...
const FormServer = ({ onSubmit, isSaving, initialData, isEdit = false }: IProps) => {

    const { capitalize: caps } = useFullIntl();
    const { handleSubmit, errors, setValue, register, control, setError, clearError } = useForm<IDataFormServer>({
        mode: "onSubmit",
