...
const SimulacionGrafica = ({ resourceData, dataForm, returnFunction, lastDateProjection }: IProps) => {
            ...
            dataSimulacionSize > 0 ? 
                (<><Col xl='12' className="justify-content-center" style={{ 'display': 'flex' }}>
                    <Col xl='6'>
                        ...
                        <Form.Group as={Row}>
                            <Form.Label column sm="3" className={'justify-content-end'} style={{ 'display': 'flex' }}> 
                                {($m(lastDateProjection,'DD-MM-YYYY').add(1, 'days')).format('DD-MM-YYYY')}
                            </Form.Label>
                            <Col sm="6">
                            ...
                            <Form.Label column sm="3"> {dataForm?.date_project} </Form.Label>
                        </Form.Group>
                    </Col>
