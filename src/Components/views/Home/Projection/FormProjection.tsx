...
const findOptionsTypeProjection = (selectedOption: string) => {
  const isSelectedOption = (element: { label: string; value: string }) =>
...
const FormProjection = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      isDataPercent: dataInitialForm
        ? dataInitialForm.isDataPercent
        : showLabelPercent.toString(),
      type_projection: dataInitialForm
        ? optionsTypeProjection[
            findOptionsTypeProjection(dataInitialForm.type_projection as string)
          ]
  ...
  const updateComponentes = async (equipoId: string) => {
    ...
    await ax
      .get<IComponente[]>("service_render/componentes/componentes_with_data", {
  ...
  return (
    <form onSubmit={handleSubmit(mappedSubmit)}>
      <Row className="text-left mt-2">
        <Col sm={3} className="text-left mb-2">
          ...
          />
          {errors.equipoId && (
            <small className="text-danger">{errors.equipoId.message}</small>
          )}
        </Col>
        <Col sm={3} className="text-left mb-2">
          <Controller
        ...
        <Col sm={2} className="text-left mb-2">
          ...
          <Controller
            ...
            as={Select}
            onChange={(data) => {
              onChangeTypeProjection !== undefined &&
                onChangeTypeProjection(data[0].value);
              return data[0];
            }}
            rules={{
              required: { value: true, message: "Complete este campo" },
        ...
        idComponentSelected !== "-1" && (
          <>
            <Row className="text-left mt-2">
              ...
              <Col sm={2} className="text-left mb-2">
                <label>
                  <b>Fecha final de proyección:</b>
                </label>
                <Controller
                  control={control}
                  name="date_project_end"
                  minDate={$m(lastDateProjection, "DD-MM-YYYY")
                    .add(5, "days")
                    .format("DD-MM-YYYY")}
                  maxDate={$m(lastDateProjection, "DD-MM-YYYY")
                    .add(90, "days")
                    .format("DD-MM-YYYY")}
                  onChange={(e) => {
                  ...
                  <Card>
                    <Card.Body>
                      <Row className={"d-flex align-items-center"}>
                        <Col sm={6}>
                          <h4>{title("variable_simulation")}</h4>
                        </Col>
                        <Col
                          sm={6}
                          className="d-flex justify-content-sm-end mt-sm-0 mt-3"
                        >
                          <Controller
                            name="isDataPercent"
                      ...
                      <Row>
                        <Col sm={4} className={"d-flex align-items-center "}>
                          <Col sm={6}>
                            ...
                            <Col sm={12}>
                              <strong>
                                ({dataPromedio?.TRAT_MOLINO} Ton/día)
                              </strong>
                            </Col>
                          </Col>
                          <Col sm={6}>
                      ...
                      <Row>
                        ...
                        >
                          <Col sm={6}>
                            ...
                            <Col sm={12}>
                              <strong>
                                ({dataPromedio?.BOLAS_TON} Ton/día)
                              </strong>
                            </Col>
                          </Col>
                          <Col sm={6}>
                            ...
                            <Col sm={8} xs={12} className="mt-sm-0 mt-4">
                              <div className="alert alert-info mb-0">
                                <i
                                  ...
                                  aria-hidden="true"
                                />
                                Especificar cada cuantas toneladas se desea
                                realizar el cambio de sentido de giro
                              </div>
                            </Col>
                          </Row>
                        </>
