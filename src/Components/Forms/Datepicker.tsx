...
export const Datepicker = (props: Props) => {
	...
	let valueDateInit = props.value ? $m(props.value,'DD-MM-YYYY').toDate() : undefined;
		...
		<div className='input-group'>
			<div className={iconClasses.join(' ')}>
		 	 ...
		 	 <DatePicker 
				...
				minDate = {props.minDate ? $m(props.minDate,'DD-MM-YYYY').toDate(): undefined}
				maxDate = {props.maxDate ? $m(props.maxDate,'DD-MM-YYYY').toDate(): undefined}
				selected={props.value ?  $m(props.value,'DD-MM-YYYY').toDate() : startDate} 
