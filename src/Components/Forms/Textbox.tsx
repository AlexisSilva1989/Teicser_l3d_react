  ...
  (props: Props, ref: React.Ref<HTMLInputElement>) => {
    ...
    const formatValue = (value: string) => {
      ...
      const formats: { [x: string]: string } = {
        ...
        "NUMBER-SEPARATOR": Format.number_format(
          value.replace(ONLY_NUMBER, "").toString(),
          0
        ),
      };
      let valueFormated: string =
        stringFormat != undefined ? formats[stringFormat] : value;
      ...
      <Fragment>
        ...
        <input
          ...
          onChange={(event) => {
            ...
            if (format != null || props.onlyNumber == true) {
