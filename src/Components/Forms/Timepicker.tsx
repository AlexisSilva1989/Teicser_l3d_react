...
export const Timepicker = (props: Props) => {
	...
	const onChangeCallback = useCallback((e: IMoment|null) => {
	...
	return <div className='msig-timepicker'>
		{props.label && <label><b>{caps(props.label)}:</b></label>}
		<div className='input-group'>
			<div className={iconClasses.join(' ')}>
				<i className='fas fa-clock input-group-text' />
			</div>
			<TimePicker inputReadOnly={props.readonly} popupClassName='z-front' onChange={onChangeCallback} showSecond={false}
				value={value} className={innerClasses.join(' ')} minuteStep={props.step ?? 15} placement='topLeft' />
		</div>
