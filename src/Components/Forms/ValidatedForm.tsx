...
import {
  ...
  acceptedFormat,
} from "./FileInputWithPreviewImage";
...
export const ValidatedForm = (props: Props) => {
        ...
        case TEXTBOX:
          el = (
            <Textbox
              ...
              onChange={
                x.name == null ? undefined : (e) => onChange(x.name!, e)
              }
        ...
        case DATEPICKER:
          el = (
            <Datepicker
              ...
              name={x.name}
              onChange={
                x.name == null ? undefined : (e: any) => onChange(x.name!, e)
              }
              readonly={x.readonly}
              disabled={x.disabled}
            />
          ...
          el = (
            <FileInputWithPreviewImage
              ...
              onChange={
                x.name == null
                  ? undefined
                  : (e) => onChange(x.name!, !e?.length ? "" : e[0])
              }
              id={x.name as string}
              name={x.name}
            />
  ...
  function invalidateAll() {
    ...
    inputs = inputs.filter(
      (x) => x != null && props.validations![$(x).attr("name")!] != null
    );
  ...
  return (
    <div>
      <form
        className="row"
        ref={form}
        onSubmit={disabledSubmit ? undefined : onSubmit}
      >
        {loading ? (
          <BounceLoader
            css={{ margin: "1.25rem auto" } as any}
            color="var(--primary)"
            size={32}
          />
        ) : (
            ...
            {props.onSubmit != null && (
              <div
                className={
                  ...
                  props.fields[props.fields.length - 1].type === EMBEDDED
                    ? "col"
                    : "col-12")
                }
              >
