...
export const FileInputWithPreviewImage = (props: Props) => {
	...
	return (
		<div>
			...
			<div className={'d-flex justify-content-center align-items-center'} style={{border: error ? '1px solid red': '1px solid transparent', backgroundColor: 'rgba(0,0,0,0.05)', width: '100%', minHeight: '200px', maxHeight: '200px'}}>
				<label htmlFor={props.id} style={{marginBottom: '0px', cursor: 'pointer'}}>
					<div>
						<img src={previewImage} alt={previewImage} style={{maxWidth: '100%', maxHeight: '198px'}}/>
					</div>
				</label>
				<input 
					id={props.id}
