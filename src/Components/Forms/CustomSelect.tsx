...
export const CustomSelect = (props: Props) => {
  ...
  const optionsValue = options?.filter((o, i) => {
    if (o.value === props.preSelect) {
      if (value) {
        if (o.value === value) return { label: caps(o.label), value: o.value };
      } else {
        if (value != "") return { label: caps(o.label), value: o.value };
      }
    } else {
      if (o.value === value) return { label: caps(o.label), value: o.value };
    }
