			...
			<Modal ref={modal} size={props.size}>
				<div className='modal-body'>
					<div className='row p-2'>
						...
						<div className='col-12'>
							<ApiTable<T> search={search} customFilter={props.customFilter} queryParams={props.queryParams} load={load} columns={props.columns} source={props.source} onSelect={onSelect} />
						</div>
					</div>
				</div>
			</Modal>
