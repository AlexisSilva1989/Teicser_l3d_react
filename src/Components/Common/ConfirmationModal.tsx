...
export const ConfirmationModal = forwardRef<HTMLDivElement, PropsWithChildren<Props>>((props: PropsWithChildren<Props>, ref: Ref<HTMLDivElement>) => {
	...
	return (
		<div className='modal' data-backdrop='static' data-keyboard='false' tabIndex={-1} role='dialog' ref={ref}>
			<div className='modal-dialog modal-md' role='document'>
				<div className='modal-content'>
					<div className='modal-header'>
						<h5 className='modal-title'>{caps(props.title ?? 'titles:confirm_action')}</h5>
					...
					<div className='modal-footer text-right p-3'>
						...
						<button className='btn btn-outline-danger' onClick={onClickCancel} data-dismiss='modal'>
