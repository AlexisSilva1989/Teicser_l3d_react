...
import { Fabricante, IDataFormFabricante } from '../../../Data/Models/Fabricante/Fabricante';
...
const EditFabricante = () => {
  ...
  const [fabricanteSelected, setFabricanteSelected] = useState<IDataFormFabricante>();
  ...
  return (<BaseContentView title="Modificar Fabricante">
