...
import { IDataFormServer, Servidor } from '../../../Data/Models/Servidor/Servidor';
...
export const EditServidores = ( ) => {
    ...
    const handleSubmit = async (data: IDataFormServer) => {
        setIsSaving(true);
        await ax.patch('service_render/servidores/edit', data)
          .then((response) => {
            goBack();
    ...
    return (<BaseContentView title="Modificar Servidor">
