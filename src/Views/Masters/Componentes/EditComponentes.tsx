...
import {
  IComponente,
  IDataFormComponente,
} from "../../../Data/Models/Componentes/Componentes";
...
export const EditComponentes = () => {
  ...
  const [componenteSelected, setComponenteSelected] =
    useState<IDataFormComponente>();
  ...
  const handleSubmit = async (data: IDataFormComponente) => {
    setIsSaving(true);
    await ax
      .patch("service_render/componentes/edit", data)
      .then((response) => {
        goBack();
        ...
        if (e.response) {
          addToast(
            e.response.data.errors
              ...
              : caps("errors:base.post", { element: "componente" }),
  ...
  return (
    <BaseContentView title="Modificar Componente">
