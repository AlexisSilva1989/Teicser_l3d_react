...
import { extendColumnsAlarms, IAlarmsEquipment, IFormAlarmsEquipment } from '../../../Data/Models/Alarmas/AlarmsEquipments'
...
function EditAlarmasEquipo() {
  ...
  const dataStateAs = stateAs<{ data: IFormAlarmsEquipment & extendColumnsAlarms}>()

  //states
  const [alarmsEquipment, setAlarmsEquipment] = useState<IFormAlarmsEquipment & extendColumnsAlarms>()
    ...
    <BaseContentView title="Modificar alarma de equipo">
      {
        isLoadModule
          ...
          : (
            <>
              <Col sm={12} className="mb-4"><Buttons.Back /></Col>
