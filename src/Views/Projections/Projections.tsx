...
const Projections = () => {
  ...
  const [areFiltersDisabled, setAreFiltersDisabled] = useState<boolean>(false);
  ...
  const [DataComponents, setDataComponents] = useState<ProjectionPolinomio[] | null>(null);
      ...
      <Col sm={12} className='px-0' id='container-charts'>
        {
          IsLoadData
            ...
            : error ? (
              ...
              <Col sm={12} className="text-center">
                <Col className="alert alert-danger mb-0 mt-5" sm={6}>
                  <i className="fa fa-exclamation-triangle mr-2" aria-hidden="true" />
                  Hubo problemas de conexión con el servidor
                </Col>
              </Col>
            )
        }
