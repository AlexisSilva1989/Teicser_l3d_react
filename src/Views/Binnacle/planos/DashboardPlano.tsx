      ...
      <BaseContentView title="Planos">
        ...
        <Col sm={1} className="pt-2">
          ...
          <Button
            ...
            onClick={() => {
              setSubModuleSelected("planos_actuales");
            }}
            className="btn-outline-primary w-100 d-flex justify-content-center align-items-center"
          >
        ...
        <Col sm={2} className="pt-2">
          ...
          <Button
            ...
            onClick={() => {
              setSubModuleSelected("planos_antiguos");
            }}
            className="btn-outline-primary w-100 d-flex justify-content-center align-items-center"
          >
        ...
        {SubModuleSelected === "planos_actuales" && (
          <PlanosActuales idEquipo={equipoSelected.id} />
        )}
        {SubModuleSelected === "planos_antiguos" && (
          <PlanosAntiguos idEquipo={equipoSelected.id} />
        )}
      </BaseContentView>
    </>
  );
