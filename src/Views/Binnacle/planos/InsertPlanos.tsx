    ...
    <BaseContentView title="Planos">
      ...
      <Col sm={2} className="pt-2">
        ...
        <Button
          ...
          onClick={() => {
            setSubModuleSelected("planos_conjunto");
          }}
      ...
      <Col sm={2} className="pt-2">
        ...
        <Button
          ...
          onClick={() => {
            setSubModuleSelected("planos_componentes");
          }}
          className="btn-outline-primary w-100 d-flex justify-content-center align-items-center"
        >
      ...
      <Col
        sm={5}
        className="pt-3 col-sm-5 d-flex d-sm-flex justify-content-end align-items-center"
      >
        <Button
          variant={"primary"}
          onClick={() => {
      ...
      <Modal show={modalNvoPlano.visible} onHide={modalNvoPlano.hide}>
        ...
        <Modal.Body>
          <FormPlano
            initialData={{
              equipo: equipoSelected.id,
              tipo_plano: SubModuleSelected,
            }}
