...
export const ColorOptions = () => {
	const colors = ['background-blue', 'background-blue', 'background-red', 'background-purple', 'background-info', 'background-green', 'background-dark'];

	const gradients = ['background-grd-blue', 'background-grd-red', 'background-grd-purple', 'background-grd-info', 'background-grd-green', 'background-grd-dark'];

	const images = ['background-img-1', 'background-img-2', 'background-img-3', 'background-img-4', 'background-img-5', 'background-img-6'];
