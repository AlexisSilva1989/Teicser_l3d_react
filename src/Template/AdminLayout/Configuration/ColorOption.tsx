...
const ColorOption = (props: Props) => {
	...
	return (
		<a href={Links.BLANK} onClick={onChangeColor} className={props.headerColor === props.color ? 'active' : ''} data-value={props.color}>
			<span />
			<span />
		</a>
	);
...
const mapProps = (state: IAppState, props: IForwardProperties): Pick<Props, 'color' | 'headerColor'> => {
	return {
		color: props.color,
