...
export const UsuarioColumns: (intl: IntlShape) => IDataTableColumn<Usuario>[] =
  (intl) => {
    ...
    return [
      ...
      },
      {
        ...
        format: (x) =>
          x.nombre_trabajador
            ? x.nombre_trabajador
            : header("labels:common.not_applicable"),
      },
      {
        selector: "rol",
      ...
      },
      {
        ...
        format: (x) =>
          header(x.activo ? "labels:common.yes" : "labels:common.no"),
      },
    ];
  };
