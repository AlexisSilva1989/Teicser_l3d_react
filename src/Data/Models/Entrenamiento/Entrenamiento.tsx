...
export const EntrenamientoColumns: (
  intl: IntlShape
) => IDataTableColumn<IEntrenamiento>[] = (intl) => {
  ...
  return [
    ...
    },
    {
      ...
      name: "Segmentos",
      cell: (entrenamiento) =>
        entrenamiento.segments_generate ? (
    ...
    },
    {
      ...
      name: "Perfil nominal",
      cell: (entrenamiento) =>
        entrenamiento?.perfil_nominal_exist &&
        entrenamiento?.perfil_nominal_exist > 0 ? (
          <i className="text-success fa fa-check" />
        ) : (
          <i className="text-danger fa fa-times" />
        ),
    ...
    },
    {
      ...
      name: "Perfil crítico",
      cell: (entrenamiento) =>
        entrenamiento?.perfil_critico_exist &&
        entrenamiento?.perfil_critico_exist > 0 ? (
          <i className="text-success fa fa-check" />
        ) : (
          <i className="text-danger fa fa-times" />
        ),
