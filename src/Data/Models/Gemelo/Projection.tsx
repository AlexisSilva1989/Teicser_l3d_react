...
export const ProjectionsColumns: (
  intl: IntlShape
) => IDataTableColumn<Projection>[] = (intl) => {
  ...
  return [
    ...
    {
      selector: "fecha_medicion",
      name: header("columns:fecha_medicion"),
      width: "13%",
    },
    { selector: "fecha_end_xample", name: "Fecha a proyectar", width: "13%" },
    { selector: "dias_proyectar", name: "Días", width: "7%" },
    {
      selector: "fecha_simulacion",
      name: header("columns:fecha_simulacion"),
      width: "15%",
    },
